...
const getStyles = (colors: any) => StyleSheet.create({
  ...
  emailText: { fontFamily: FontFamily.lexendDecaMedium, fontSize: FontSize.fs_14, color: colors.textSecondary },
  infoText: { fontFamily: FontFamily.lexendDecaRegular, fontSize: FontSize.fs_14, color: colors.textSecondary, lineHeight: 22, marginBottom: Gap.gap_20 },
