...
const getStyles = (colors: any) => StyleSheet.create({
      ...
      roundText: { fontFamily: FontFamily.lexendDecaBold, fontSize: FontSize.fs_20, color: colors.text },
      titleText: { fontFamily: FontFamily.lexendDecaBold, fontSize: FontSize.fs_20, color: colors.cam },
      descriptionBox: { width: '100%', backgroundColor: colors.greenLight, padding: Padding.padding_20, borderRadius: Border.br_20, borderWidth: 1.5, borderColor: colors.main, borderStyle: 'dashed', alignItems: 'center' },
      descriptionText: { fontFamily: FontFamily.lexendDecaMedium, fontSize: FontSize.fs_14, color: colors.text, textAlign: 'center', lineHeight: 22 },
