...
export default function PaymentSuccessScreen() {
  ...
  return (
    <LinearGradient
      ...
      colors={[colors.primary, colors.background, colors.vang]}
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.mainIconContainer}>
            <CheckFatIcon size={80} color={colors.primary} weight="fill" />
          </View>
...
const getStyles = (colors: any) => StyleSheet.create({
  ...
  sText: {
    ...
    color: colors.primary, // Dùng màu xanh đậm mờ trên nền sáng sẽ rất sang trọng
  },
  ...
  title: {
    ...
    color: colors.textBrand, // Vàng chanh
  ...
  message: {
    ...
    color: colors.textPrimary, // Màu trắng
    textAlign: 'left',
  ...
  primaryButtonText: {
    ...
    color: colors.textPrimary, // Chữ màu đen đậm
  },
});