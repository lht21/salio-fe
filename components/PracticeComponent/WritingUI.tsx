        ...
        <BottomSheetView style={styles.modalContentSheet}>
          <View style={styles.modalHeaderRow}>
            ...
            <TouchableOpacity style={styles.modalCloseBtn} onPress={() => instructionSheetRef.current?.dismiss()}>
              <XIcon size={20} color={colors.text} weight="bold" />
            </TouchableOpacity>
          </View>
...
const getStyles = (colors: any) => StyleSheet.create({
      ...
      topicBanner: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: colors.bg, padding: Padding.padding_15, marginHorizontal: Padding.padding_15, borderRadius: Border.br_15, marginBottom: Gap.gap_15, borderWidth: 2, borderColor: '#C8E6C9' },
      topicTitle: { flex: 1, fontFamily: FontFamily.lexendDecaMedium, fontSize: FontSize.fs_14, color: colors.color, lineHeight: 20, marginRight: Gap.gap_10 },
      ...
      openModalText: { fontFamily: FontFamily.lexendDecaMedium, fontSize: FontSize.fs_12, color: colors.text },
      bottomBar: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: Padding.padding_15, paddingVertical: Padding.padding_10, backgroundColor: colors.bg, borderTopWidth: 1, borderTopColor: colors.stroke },
      charCountPill: { backgroundColor: colors.main, paddingHorizontal: 16, paddingVertical: 8, borderRadius: Border.br_20 },
      charCountText: { fontFamily: FontFamily.lexendDecaSemiBold, fontSize: FontSize.fs_12, color: colors.color },
      rulesButton: { flexDirection: 'row', alignItems: 'center', gap: Gap.gap_8, paddingHorizontal: Padding.padding_10 },
      rulesText: { fontFamily: FontFamily.lexendDecaMedium, fontSize: FontSize.fs_12, color: colors.color },
      ...
      modalHeaderTitle: { fontFamily: FontFamily.lexendDecaSemiBold, fontSize: FontSize.fs_16, color: colors.text },
      modalCloseBtn: { width: 32, height: 32, borderRadius: 16, backgroundColor: colors.stroke, justifyContent: 'center', alignItems: 'center' },
      topicFullText: { fontFamily: FontFamily.lexendDecaMedium, fontSize: FontSize.fs_16, color: colors.text, lineHeight: 24, marginBottom: Gap.gap_10 },
      instructionText: { fontFamily: FontFamily.lexendDecaRegular, fontSize: FontSize.fs_14, color: colors.gray, fontStyle: 'italic' },
      ruleItem: { flexDirection: 'row', alignItems: 'flex-start', marginBottom: Gap.gap_20 },
      ruleBadge: { width: 36, height: 36, borderRadius: 18, backgroundColor: colors.greenLight, justifyContent: 'center', alignItems: 'center', marginRight: Gap.gap_15, marginTop: 2 },
      ruleBadgeText: { fontFamily: FontFamily.lexendDecaSemiBold, fontSize: FontSize.fs_16, color: colors.color },
