        ...
        <View style={styles.detailsBox}>
          ...
          <View style={styles.detailRow}>
            ...
            <TouchableOpacity style={styles.copyBtn} onPress={() => copyToClipboard(safeAccountNo, 'số tài khoản')}>
              <CopyIcon size={20} color={Color.gray} weight="duotone" />
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.detailRow}>
            <View style={styles.detailTextContainer}>
              ...
              <Text style={[styles.detailValue, { color: Color.cam }]}>{safeOrderId}</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  // Header
  header: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: Padding.padding_15, paddingTop: Padding.padding_10, paddingBottom: Padding.padding_15, backgroundColor: Color.bg },
  ...
  instructionText: { fontFamily: FontFamily.lexendDecaRegular, fontSize: FontSize.fs_14, color: Color.gray, textAlign: 'center', marginVertical: Gap.gap_20, lineHeight: 22 },
  
  // QR Image
  qrContainer: { alignItems: 'center', marginBottom: Gap.gap_22, backgroundColor: '#FFF', padding: 15, borderRadius: Border.br_20, borderWidth: 1, borderColor: Color.stroke, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.05, shadowRadius: 10, elevation: 3 },
  qrImage: { width: 280, height: 280 },
  
  // Details Box
  detailsBox: { backgroundColor: '#F8FAFC', borderRadius: Border.br_15, padding: Padding.padding_15, borderWidth: 1, borderColor: Color.stroke },
  ...
  detailLabel: { fontFamily: FontFamily.lexendDecaRegular, fontSize: FontSize.fs_12, color: Color.gray, marginBottom: 4 },
  detailValue: { fontFamily: FontFamily.lexendDecaMedium, fontSize: FontSize.fs_14, color: Color.text },
  amountValue: { fontFamily: FontFamily.lexendDecaSemiBold, fontSize: FontSize.fs_16, color: Color.color }, // Màu nổi bật cho tiền
  
  // Utils
  copyBtn: { padding: 8, backgroundColor: '#E2E8F0', borderRadius: Border.br_10 },
  divider: { height: 1, backgroundColor: Color.stroke, opacity: 0.5 },
  
  // Footer
  footer: { paddingHorizontal: Padding.padding_15, paddingTop: Padding.padding_15, paddingBottom: Padding.padding_30, backgroundColor: Color.bg, borderTopWidth: 1, borderTopColor: Color.stroke }
});