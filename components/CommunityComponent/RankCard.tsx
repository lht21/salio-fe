  ...
  return (
    <View style={[styles.rankCard, isCurrentUser && styles.currentUserCard]}>
      <View style={styles.rankCardLeft}>
        ...
        <Text style={[styles.rankName, isCurrentUser && { color: colors.primary }]} numberOfLines={1}>
          {item.name}
        </Text>
      </View>
...
const getStyles = (colors: any) => StyleSheet.create({
  rankCard: {
    ...
    backgroundColor: colors.background, borderRadius: Border.br_20, padding: Padding.padding_15,
    marginBottom: Gap.gap_10, borderWidth: Stroke.stroke, borderColor: colors.borderDefault,
  },
  rankCardLeft: { flexDirection: 'row', alignItems: 'center', flex: 1 },
  rankNumberWrapper: { flexDirection: 'row', alignItems: 'baseline', width: 38 },
  hashText: { fontFamily: FontFamily.lexendDecaMedium, fontSize: 11, color: colors.primary, marginRight: 2 },
  rankText: { fontFamily: FontFamily.lexendDecaBold, fontSize: FontSize.fs_16, color: colors.textPrimary },
  rankAvatar: { width: 40, height: 40, borderRadius: 20, marginHorizontal: Gap.gap_10 },
  rankName: { fontFamily: FontFamily.lexendDecaSemiBold, fontSize: FontSize.fs_14, color: colors.textPrimary, flex: 1 },
  ...
  currentUserCard: { borderColor: colors.primary, backgroundColor: '#F0FDF4', marginBottom: 0, borderWidth: 2 },
});