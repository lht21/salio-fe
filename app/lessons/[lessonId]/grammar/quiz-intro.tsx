...
const styles = StyleSheet.create({
  ...
  roundText: { fontFamily: FontFamily.lexendDecaBold, fontSize: FontSize.fs_20, color: Color.text },
  titleText: { fontFamily: FontFamily.lexendDecaBold, fontSize: FontSize.fs_20, color: Color.cam },
  descriptionBox: { width: '100%', backgroundColor: Color.greenLight, padding: Padding.padding_20, borderRadius: Border.br_20, borderWidth: 1.5, borderColor: Color.main, borderStyle: 'dashed', alignItems: 'center' },
  descriptionText: { fontFamily: FontFamily.lexendDecaMedium, fontSize: FontSize.fs_14, color: Color.text, textAlign: 'center', lineHeight: 22 },
