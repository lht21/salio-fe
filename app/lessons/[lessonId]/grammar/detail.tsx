    ...
    <View style={styles.contentContainer}>
          ...
          <View style={styles.ruleList}>
            {rules.map((rule, idx) => (
              <View key={idx} style={styles.ruleItem}>
                <CaretRight size={16} color={Color.cam} weight="bold" style={{ marginTop: 2 }} />
            ...
            <View style={styles.exampleList}>
              {grammar.exampleSentences.map((ex, idx) => (
                <View key={idx} style={styles.exampleItem}>
                  ...
                  >
                    <SpeakerHigh size={24} color={Color.main} weight="fill" />
                  </TouchableOpacity>
                </View>
              ))}
            </View>
      ...
      <View style={styles.footerActions}>
        ...
        <Button 
          ...
          textStyle={{ color: Color.gray, textDecorationLine: 'underline' }}
        />
      </View>
    </View>
  );
